...
def extractor(cluster, path_data='/home/gabriele/Scrivania/p-lcpa/data/', dyn='Dyn/'):  # This function gathers all the data in one single Dataframe specific for a type of Cluster
